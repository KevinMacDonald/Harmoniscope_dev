...
//  writeBuf[1] = 0xC3;   	// This sets the 8 MSBs of the config register (bits 15-8) to 11000011
  writeBuf[1] = 0xC1;   	// This sets the 8 MSBs of the config register (bits 15-8) to 11000001
  ...
  printf("Voltage Reading %f (V) \n", (float)val*6.144/32767.0);	// Print the result to terminal, first convert from binary value to mV
